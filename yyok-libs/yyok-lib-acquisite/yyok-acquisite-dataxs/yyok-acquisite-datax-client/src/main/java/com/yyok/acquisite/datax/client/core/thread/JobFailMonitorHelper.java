package com.yyok.acquisite.datax.client.core.thread;
...
public class JobFailMonitorHelper {
	...
	public void start(){
		...
		monitorThread.setName("datax-web, client JobFailMonitorHelper");
		monitorThread.start();
	}
	...
	private boolean failAlarm(JobInfo info, JobLog jobLog){
		...
		if (info!=null && info.getAlarmEmail()!=null && info.getAlarmEmail().trim().length()>0) {
			...
			String personal = I18nUtil.getString("client_name_full");
