...
@Repository
@Mapper
public interface IColumnInfoMapper extends ICoreMapper<ColumnConfig> {

    @Select("<script>select table_name ,create_time , engine, table_collation as coding, table_comment as comment from information_schema.tables " +
