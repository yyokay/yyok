<h1 style="text-align: center">YYOK意象yyok系统</h1>

#### 项目简介
YYOK基于当前流行技术组合的前后端分离yyok系统： SpringBoot2+MybatisPlus+SpringSecurity+jwt+redis+Vue的前后端分离的yyok系统， 包含分类、sku、运费模板、素材库、小程序直播、拼团、砍价、商户管理、 秒杀、优惠券、积分、分销、会员、充值、多门店等功能，更适合企业或个人二次开发；
...
#### 反馈交流
- 喜欢这个yyok后台的小伙伴留下你的小星星啦,star,star哦！
