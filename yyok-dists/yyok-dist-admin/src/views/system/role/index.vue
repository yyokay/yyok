...
import {getResourcesTree} from '@/api/system/resource'
...
// crud交由presenter持有
const defaultCrud = CRUD({ title: '角色', url: 'api/sys/roles', sort: 'level,asc', crudMethod: { ...crudRoles }})
