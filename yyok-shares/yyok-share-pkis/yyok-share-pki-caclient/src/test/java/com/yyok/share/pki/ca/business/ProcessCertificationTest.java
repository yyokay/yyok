package com.yyok.share.pki.ca.business;
...
import com.yyok.share.pki.ca.client.ProcessCertification;
import com.yyok.share.pki.ca.client.ProcessCertificationResult;
import com.yyok.share.pki.ca.client.ProcessRequestException;
...
import com.yyok.share.pki.profile.impl.ProfilesJAXB;
import com.yyok.share.pki.ca.util.GeneratePKI;
import com.yyok.share.pki.util.PKIKeyStore;
import com.yyok.share.pki.util.PKIKeyStoreSingleton;
...
public class ProcessCertificationTest {
	...
	public void testCertificationRequest() throws NoSuchAlgorithmException,
		...
		Profiles profiles = (Profiles) new ProfilesJAXB(
		...
		assertEquals(PKIStatus.GRANTED, processCertificationResult.getPkiStatus().getValue().intValue());
