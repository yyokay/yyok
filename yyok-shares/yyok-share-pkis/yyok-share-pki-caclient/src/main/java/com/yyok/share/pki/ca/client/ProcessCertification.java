...
public class ProcessCertification {
    ...
    /* private methods */
    public ProcessCertificationResult processRequest(CertTemplate certTemplate, int profile) throws ProcessRequestException, IOException, ProfileException, NoSuchProviderException, OperatorCreationException, NoSuchAlgorithmException {
