...
public interface DatabaseInterface {
    ...
    /**
     * Returns the minimal SQL to launch in order to determine the layout of the resultset for a given com.com.yyok.acquisite.datax.client.tool.database table
     *
