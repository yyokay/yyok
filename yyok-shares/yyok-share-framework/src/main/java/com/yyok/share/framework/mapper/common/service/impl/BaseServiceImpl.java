package com.yyok.share.framework.mapper.common.service.impl;
...
import com.yyok.share.framework.mapper.common.web.param.OrderQueryParam;
import com.yyok.share.framework.mapper.common.web.param.QueryParam;
...
public abstract class BaseServiceImpl<M extends BaseMapper<T>, T> extends ServiceImpl<M, T> implements IBaseService<T> {
    ...
    public void removeByCodes(List<String> coders) {

    }

    public void removeByCode(String coder) {

    }

    public T findByCode(String coder) {
