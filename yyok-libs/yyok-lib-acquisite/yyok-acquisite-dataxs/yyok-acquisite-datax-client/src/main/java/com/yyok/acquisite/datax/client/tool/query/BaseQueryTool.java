...
import com.yyok.acquisite.datax.client.tool.database.ColumnInfo;
import com.yyok.acquisite.datax.client.tool.database.DasColumn;
import com.yyok.acquisite.datax.client.tool.database.TableInfo;
import com.yyok.acquisite.datax.client.tool.meta.DatabaseInterface;
import com.yyok.acquisite.datax.client.tool.meta.DatabaseMetaFactory;
import com.yyok.share.framework.utils.AESUtil;
import com.yyok.acquisite.datax.client.util.JdbcConstants;
import com.yyok.acquisite.datax.client.util.JdbcUtils;
...
public abstract class BaseQueryTool implements QueryToolInterface {
    ...
    public static void executeCreateTableSql(String querySql) {
