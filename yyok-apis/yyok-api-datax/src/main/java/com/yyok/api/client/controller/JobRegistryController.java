...
import com.yyok.acquisite.datax.client.util.PageUtils;
...
public class JobRegistryController extends BaseController {
	...
	public IPage<JobRegistry> selectAll() {
		BaseForm baseForm = new BaseForm();
		return this.IJobRegistryService.page(baseForm.getPlusPagingQueryEntity(), pageQueryWrapperCustom(baseForm.getParameters()));
	}
