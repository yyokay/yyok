...
import com.yyok.acquisite.datax.client.core.conf.JobAdminConfig;
import com.yyok.acquisite.datax.client.core.route.ExecutorRouteStrategyEnum;
...
import com.yyok.acquisite.datax.client.entity.JobGroup;
import com.yyok.acquisite.datax.client.entity.JobInfo;
import com.yyok.acquisite.datax.client.entity.JobLog;
import com.yyok.acquisite.datax.client.tool.query.BaseQueryTool;
import com.yyok.acquisite.datax.client.tool.query.QueryToolFactory;
import com.yyok.acquisite.datax.client.util.JSONUtils;
...
public class JobTrigger {
    ...
    private static void processTrigger(JobGroup group, JobInfo jobInfo, int finalFailRetryCount, TriggerTypeEnum triggerType, int index, int total) {
        ...
        triggerMsgSb.append("<br>").append(I18nUtil.getString("jobconf_trigger_client_adress")).append("：").append(IpUtil.getIp());
